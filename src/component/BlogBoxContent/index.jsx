...
const BlogBoxContent = ({ data }) => {
  ...
  return (
    <>
    <div className="content-blog-info-container mt-2 shadow">
        ...
        <div className="blog-info">
          <div className="editing-content">
            <div className="editing-content-container">
              {user && show && data?.creator === user?._id ? (
                <div className="p-2 shadow content-view-edit">
                  ...
                  <div className="content-btn d-flex justify-content-start align-items-center text-danger pointer p-1">
          ...
          <div className="blog-title text-wrap">{data.title}</div>
          <div className="blog-content-description text-wrap">
            {innerText().length > 200 ? innerText() + "..." :  innerText()}
          </div>
          ...
          <div className="blog-date-info">
            June 14 <span className="circle">|</span>{" "}
            <span className="time-sched"> 3 min ago</span>
          </div>
        </div>
      </div>
